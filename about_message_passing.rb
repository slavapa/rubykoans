...
#https://github.com/javierjulio/ruby-koans-completed/blob/master/about_message_passing.rb
#https://github.com/mlsimpson/rubykoans
class AboutMessagePassing < Neo::Koan
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert mc.send("CAUGHT?".downcase { |n|  } )      # What would you need to do to the string?
  end
